...
class Parser {
   ...
   private:
      ...
      bool parse_stmt();
      bool parse_stmt_ass_proc_tail(expr_type &stmt_ass_proc_tail_type,Register *&stmt_ass_proc_tail_reg);
      bool parse_assignment_stmt_tail(expr_type &assignment_stmt_tail_type, Register *&assignment_stmt_tail_reg);
      bool parse_if_stmt();
      ...
      bool parse_expr_hat(expr_type &expr_hat_type,Register *&expr_hat_reg);
      bool parse_simple_expr(expr_type &simple_expr_type,Register *&simple_expr_reg);
      bool parse_simple_expr_prm(expr_type &simple_expr_prm_type, Register *&simple_expr_prm_reg);
      bool parse_term(expr_type &term_type,Register *&term_reg);
      bool parse_term_prm(expr_type &term_prm_type,Register *&term_prm_reg);
      ...
      void type_error(string *expected);
	...
	* is in during the parsing of actual paramaters and formal parameters.
	*/
      int parm_pos;
